...
from vmhp.tools.common import SOURCE_NAMES, iter_feature_batches, load_feature_file, num_classes_from_features, weighted_f1_acc
...
def main():
    parser = argparse.ArgumentParser(description="Train non-structured cached-feature heads for VMH-P controls.")
    ...
    result.update(
        {
            "format": "vmhp_cached_head_control_v1",
            "head": args.head,
            "sources": sources,
